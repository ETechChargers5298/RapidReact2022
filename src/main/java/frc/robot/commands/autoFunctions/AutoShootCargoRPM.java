...
public class AutoShootCargoRPM extends ParallelCommandGroup {
  /** Creates a new AutoShootCargo. */
  public AutoShootCargoRPM(double RPM, Shooter shooter, Feeder feeder, Loader loader) {
    /**  Add your commands in the addCommands() call, e.g.
     addCommands(new FooCommand(), new BarCommand()); */
    addCommands(
      new ParallelRaceGroup(

        new ShooterDesiredRPM(shooter, RPM),
