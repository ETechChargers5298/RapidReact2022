...
public class AutoReal3CargoBlue extends SequentialCommandGroup {
  /** Creates a new AutoReal2Cargo. */
  public AutoReal3CargoBlue(Intake intake, Shooter shooter, Feeder feeder, Drivetrain drivetrain, Loader loader) {
