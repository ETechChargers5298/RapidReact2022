...
public class AutoBlueTwoCargoA extends SequentialCommandGroup {
  /** Creates a new AutoBlueTwoCargoA. */
  public AutoBlueTwoCargoA(Drivetrain drivetrain, Intake intake, 
  Shooter shooter, Turret turret, Loader loader, Feeder feeder) {
    ...
    addCommands(
      ...
      new ParallelRaceGroup(
        new TrajectoryCommand(drivetrain).createTrajCommand(TrajectoryCommand.PATH_WEAVER_PATHS.get("TwoCargoASide")),
