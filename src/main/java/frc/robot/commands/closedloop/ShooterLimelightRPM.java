...
public class ShooterLimelightRPM extends CommandBase {
  ...
  public ShooterLimelightRPM( Shooter shooter) {
    ...
    int dis = (int) Limelight.getEstimatedDistance();
    this.desiredRPM = shooter.getRpmFromDistance(dis);
